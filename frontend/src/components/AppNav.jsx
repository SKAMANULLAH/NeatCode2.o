      ...
      >
        ...
        <div className="navbar-start gap-2">
          ...
          >
            <BrandMark size={32} />
            <span>
              <span className="font-extrabold tracking-tight">Neat</span>
          ...
          {user ? (
            <div className="dropdown dropdown-end">
              <button
                tabIndex={0}
                type="button"
                className="btn btn-ghost btn-sm h-10 px-2 sm:px-3 flex items-center gap-2 rounded-xl border border-transparent hover:border-base-300 focus-visible:outline-2 focus-visible:outline-primary"
                aria-label="User profile and settings"
              >
                <div className="avatar placeholder">
                  <div className="bg-primary/10 text-primary w-7 h-7 rounded-lg font-bold text-xs flex items-center justify-center ring-1 ring-primary/30">
              ...
              >
                ...
                {user.role === "admin" && (
                  <li>
                    <NavLink to="/admin" className="flex items-center gap-2 py-2 text-primary font-semibold">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                      </svg>
                      <span>Admin Panel</span>
            ...
            <div className="flex items-center gap-2">
              ...
              <NavLink to="/signup" className="btn btn-primary btn-sm font-semibold shadow-xs">
                Get Started
              </NavLink>
            </div>
          )}
